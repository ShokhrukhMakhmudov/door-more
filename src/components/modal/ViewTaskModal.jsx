      ...
      <Modal.Header>
        ...
        <div className="btn-box d-flex gap-3">
          ...
          <button
            ...
            aria-label="Close"
            onClick={handleViewTaskModalClose}>
        ...
        <div className="row g-3">
          <div className="col-lg-8 col-md-7">
            ...
            <div className="task-dscr">
              ...
              <p>
                Et quo odio aut aut natus facere consequatur eius. Eos non enim
                repudiandae voluptatem. Animi libero illo tempora. Id ut autem
                quis omnis fuga. Enim est reiciendis et. Ipsam autem maxime
                culpa quos. Velit reiciendis eos saepe. Nemo ut officiis dolores
                sequi error cum eum facilis. Praesentium porro porro ipsa nihil
                ipsum rerum sint. Sit omnis consequatur consequatur voluptates
                ipsa. Quam in occaecati alias sapiente voluptas eveniet.
                Consequuntur non deserunt exercitationem amet.
              </p>
              ...
              <div className="single-comment">
                ...
                <div className="part-txt">
                  <p>
                    ...
                    Repellat laborum, minus iste nam deleniti enim eveniet illum
                    tempore hic non quam id voluptates veniam ullam inventore
                    autem odit, recusandae earum.
                  </p>
                </div>
              </div>
            </div>
